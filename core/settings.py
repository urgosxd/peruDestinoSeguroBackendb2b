"""
Django settings for b2bpdsBackend project.
...
SECRET_KEY = 'django-insecure-#cb+x^k8$_)6c+zd-a(uoxucq7cu#1oj3t8p0@^ety)-qm%jtc'
...
ACCOUNT_AUTHENTICATION_METHOD = 'emai'
...
# }
DATABASES = {
        'default':dj_database_url.config(default="mysql://uzmduhmy_josue:Admin123321Admin@single-5922.banahosting.com:3306/uzmduhmy_django_mysql", conn_max_age=600),
        }
